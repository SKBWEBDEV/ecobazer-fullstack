    ...
    <div className="container-app flex min-h-[80vh] items-center justify-center py-14">
      <div className="w-full max-w-md card-surface p-8 animate-fadeUp">
        <div className="mb-6 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-ink-900/55">Log in to continue to EcoBazer.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-sm font-medium text-moss-700 hover:text-moss-800">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-ink-900/55">
          ...
          <Link to="/register" className="font-medium text-moss-700 hover:text-moss-800">
            Sign up
          </Link>
        </p>
      </div>
